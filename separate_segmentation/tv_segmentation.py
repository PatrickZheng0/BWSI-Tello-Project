...
img = cv2.imread('separate_segmentation/screenshot_img.jpg')
...
left_side = cv2.line(largest_contour, (x, y), (x, y + h), (0, 255, 0), 2)
right_side = cv2.line(largest_contour, (x + w, y), (x + w, y + h), (0, 255, 0), 2)
top_side = cv2.line(largest_contour, (x, y + h), (x + w, y + h), (0, 255, 0), 2)
bottom_side = cv2.line(largest_contour, (x, y), (x + w, y), (0, 255, 0), 2)
